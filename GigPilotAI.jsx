...
/* ============================================================
   ...
   Stack: React (single file), Anthropic API for AI features
      ...
      <div className="card" style={{marginTop:24}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:14}}>
          {[
            ...
            <div key={r.l} style={{background:"var(--surface)",borderRadius:var_r,padding:"12px 14px",borderRadius:"var(--r)"}}>
...
// fix for template literal in JSX
const var_r = "var(--r)";
